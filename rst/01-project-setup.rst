...
..	note::
    ...
    in 2005. If this causes confusion, I apologize to the others trying to
    build similar systems.

Step 2: Create Project Directories
**********************************

Following the guidance found in the `Minimal Structure`_ documentation on
PyPi_, we begin work by setting up a simple file structure:
...
to host your public view of the project code. (I have long supported free
tools such as these to my Computer Science students!)
